...
char package_name[MAXLINE] = "RTLoc";
char prog_name[MAXLINE] = "RTLoc";
char prog_ver[MAXLINE] = TOSTRING(VERSION);
char prog_date[MAXLINE] = TOSTRING(DATE);
char prog_copyright[MAXLINE] = "(c) 2006-2013 C. Satriano and A. Lomax";
int message_flag;
